...
public class WillsonFragment2 extends Fragment {

    private RecyclerView willson_fragment2_recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private List<WillsonModel> willsonModels;
    private WillsonFragment2Adapter willsonFragment2Adapter;
    private String myUid;
    private String roomKey;

    public WillsonFragment2(){

    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
            View view = inflater.inflate(R.layout.willson_fragment2,null);
        ...
        willson_fragment2_recyclerView = view.findViewById(R.id.willson_fragment2_recyclerview);
        ...
        willsonFragment2Adapter = new WillsonFragment2Adapter(willsonModels, getActivity());
        willson_fragment2_recyclerView.setAdapter(willsonFragment2Adapter);
        ...
        FirebaseDatabase.getInstance().getReference().child("chatRooms").child(setRoomKey).child("askerUser").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    willsonFragment2Adapter.notifyDataSetChanged();
