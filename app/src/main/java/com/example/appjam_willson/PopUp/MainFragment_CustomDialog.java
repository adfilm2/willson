...
public class MainFragment_CustomDialog extends Dialog {
...
//        wilson_image = (ImageView) findViewById(R.id.list_pop_image);
    ...
    public MainFragment_CustomDialog(Context context, String text, String keep_text, String exit_text, View.OnClickListener keep_listener, View.OnClickListener exit_listener) {
        super(context);
