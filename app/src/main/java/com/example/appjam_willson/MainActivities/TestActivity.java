...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<HelperRegistResponseModel> call_helper = retrofitAPI.helper_regist_post(token, helperRegistModel);
        call_helper.enqueue(retrofitCallback);

    }
    private Callback<HelperRegistResponseModel> retrofitCallback = new Callback<HelperRegistResponseModel>() {
